...
# STATEMENT RESTREVAL USING CuRl Comand

```bash
curl -X POST https://getbalance.live/statement/cc_no=credit_Crd_number -H "X-Api-Key: your_api_key" -H "X-Secret-Key: your_secret_key"
```
- ***NOTE***: Make sure to replace Credit_Card_number, your_api_key, your_secret_key with your actual keys.
# Success Response:
```json
     {
        "amount": "-1200.00",
        "dateTime": "2024-06-05",
        "merchant": "Forex Adjustment Fee"
      },
      {
        "amount": "-12000.00",
        "dateTime": "2024-06-04",
        "merchant": "GOOGLE *Telegram         g.co/helppay#US"
      },
      {
        "amount": "20000.00",
        "dateTime": "2024-06-04",
        "merchant": "M-PESA VISA Card Issuer"
      },
      {
        "amount": "-30000.00",
        "dateTime": "2024-06-03",
...
# Replace with your actual values
url = 'https://getbalance.live/statement/cc_no=credit_card_number'
api_key = 'your_api_key'
secret_key = 'your_secret_key'
...
// Replace with your actual values
const url = 'https://getbalance.live/statement/cc_no=credit_card_number';
const apiKey = 'your_api_key';
const secretKey = 'your_secret_key';
